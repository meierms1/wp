...
class SR20Interpolator():
    ...
    def IFRclimb(self, flaps=True):
        ...
        y = [-20, 0, 20, 40, 50]
        z = [2600, 3150]
        heavy50 = [[862,816,769,721,698],[752,706,658,610,586],[643,595,547,498,474],[533,485,435,386,361],[423,374,323,273,248],[313,262,211,160,134]] #fpm
        light50 = [[1159,1109,1056,1003,976],[1033,981,928,874,847],[906,854,800,745,718],[780,726,671,616,589],[654,599,543,487,459],[527,471,415,358,329]]
        x0 = [0,2000,4000,6000,8000,10000,12000,14000]
        heavy0 = [[646,583,526,473,448],
                 [547,488,435,385,362],
                 [453,398,348,302,281],
                 [363,312,266,223,203],
                 [278,231,188,148,129],
        ...
        light0 = [[857,780,710,645,615],
                 ...
                 [140,93,51,12,-6]]
        if flaps:
            f = RegularGridInterpolator((x, y), heavy50, method="linear", bounds_error=False, fill_value=None)
...
class crosscountry():
    ...
    def cruise(self):
        ...
        x = [[[94,86,81,77,72,67,62,58,53],[90,82,77,73,68,64,59,55,50],[85,78,73,69,65,61,56,52,48]],
            ...
            [[71,65,60,55,50,45],[67,61,56,52,47,43],[64,58,54,49,45,41]],
        ...
        gph = [[[16.5,14.9,14.2,13.5,13.3,12.5,11.7,11.0,10.2],[15.8,14.2,13.6,12.3,11.6,10.9,10.3,9.6,9.0],[15.2,13.7,11.5,10.9,10.3,9.7,9.1,8.5,8.0]],
                ...
                [[12.7,11.5,10.7,9.9,9.1,8.4],[11.0,10.0,9.3,8.6,8.0,7.3],[9.7,8.8,8.2,7.6,7.1,6.5]],
